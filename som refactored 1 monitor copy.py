...
###SOM
SOM_MODEL = 'som20240630.p'
SIGMA = 0.139099999999999
D_THRESHOLD = 0.13309999999999966
MEAN_STD_DICT = [(5.859651345851808, 4.108635928476103), 
                 (5.163579388055372, 4.766385146457139), 
                 (0.4914131701108134, 1.0650466840364472), 
                 (0.08352360984968017, 0.18124781089100866), 
                 (53037.1202247191, 279940.165663548)]
##################SOM######################
...
with open(SOM_MODEL, 'rb') as infile:
...
def make_prediction(input_value):
    ...
    prediction = predict_ddos(preprocessed_input)
    return prediction
